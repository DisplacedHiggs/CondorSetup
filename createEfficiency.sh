...
do
    ...
    while read subdir
    do
	indir=/store/group/lpchbb/mwalker/2016/DisplacedDijet/${process}/${dir1}/${dir2}/${subdir}/
	filelist=${process}_${subdir}.list
	...
	condorFile=$SCRIPTDIR/submitEfficiency_${sample}_${subdir}.condor
